...
export default function AchivementName({ achievement, isActive, setCurrentId }: Props) {
  return (
    <div
      ...
      className={`p-3 cursor-pointer border-l-4 border-[#3d3d3d] dark:border-white ${isActive ? "bg-white dark:bg-[#3d3d3d] dark:text-white" : "hover:bg-white dark:hover:bg-[#3d3d3d] active:bg-white"}`}
    >
