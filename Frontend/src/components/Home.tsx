...
export default function Home() {
  ...
  return (
    <section className="max-w-dvw max-h-dvh p-2 relative bg-[url(/img/homeBg.jpg)] bg-cover bg-center" id="home">
        ...
        <h2 className="md:text-[4.6rem] sm:text-6xl text-5xl leading-[1.10] font-bold text-[#3d3d3d] dark:text-gray-100">
          Sunjay Kumar</h2>
        <p className="md:text-5xl sm:text-4xl text-3xl sm:mt-0 mt-2 font-bold text-[#6a6a6a] dark:text-gray-200">Full Stack Developer </p>
        <p className=" md:text-2xl sm:text-xl text-lg text-[#6a6a6a] mt-6 dark:text-gray-200">Building robust, scalable,
          and efficient web
          solutions</p>
      </div>
      <div className="mt-[3.75rem] space-x-4 flex justify-center">
        <button onClick={()=> scrollMe('contact')}
          className="max-w-3xl py-3 px-6 font-medium box-border bg-[#3d3d3d] text-white dark:text-[#3d3d3d] dark:bg-white border rounded-md hover:opacity-90 active:opacity-90">Get
          in Touch</button>
        ...
        <button onClick={() => downloadResume()}
          ...
          <svg xmlns="http://www.w3.org/2000/svg"
            className="w-5 h-5 dark:opacity-90 dark:hover:opacity-70"
      ...
      {/* bouncing arrow */}
      <div onClick={() => scrollMe('about')}
        className="flex justify-center items-center dark:text-white sm:mt-8 mt-12 select-none">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
          strokeLinecap="round" strokeLinejoin="round"
          className="w-8 h-8 animate-bounce dark:opacity-90 dark:hover:opacity-70 opacity-60 cursor-pointer hover:opacity-40">
